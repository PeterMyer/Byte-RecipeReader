            ...
            <div>
                <div className="landingPage-icon-row">
                    <div className="landingPage-icon-container">
                        ...
                        <img width = "300px" src={FavRecipeIcon} alt = "favRecipe"/>
                    </div>
                    <div className="landingPage-icon-container">
                        <h3>Upload Images of <br/> Ingredients and Instructions</h3>
                        <img width = "250px" src={ImgCaptureIcon} alt="imgCaptureIcon"/>
                    </div>
                </div>
                <div className="landingPage-icon-row">
                    <div className="landingPage-icon-container">
                        <h3>Parse Text From Images</h3>
                        <img width = "250px" src={MagnifyIcon} alt ="magnifyIcon"/>
                    </div>
                    <div className="landingPage-icon-container">
                        <h3>Generate <br/> Recipe and Nutrition Info</h3>
                        <img width = "250px" src={RecipeIcon} alt = "recipeIcon"/>
                    </div>
                </div>
            </div>
        </article>
